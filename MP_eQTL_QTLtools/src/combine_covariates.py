...
combined_df.columns = ["SampleID"] + list(combined_df.columns)[1:]
combined_df.to_csv(os.path.join(args.output_dir, args.prefix+'.combined_covariates.txt'), sep=' ', index=False)#, float_format='%.6g')
print('done.')